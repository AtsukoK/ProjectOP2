...
class Player():
    def __init__(self):
        ...
        self.boat1_move = False
        self.boat2_move = False
        self.boat3_move = False
        self.boat4_move = False
        self.boat5_move = False
        self.boat6_move = False
        self.boat7_move = False
        self.boat8_move = False
